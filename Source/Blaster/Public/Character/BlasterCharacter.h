...
protected:
	...
	// Poll for any valid classes and initialize our HUD
	void PollInit();
...
private:
	...
	void SetCameraHeight(float DeltaTime);
	...
	UMaterialInstance* OriginalMaterial0;
	...
	UPROPERTY(EditAnywhere, Category = Elim)
	UMaterialInstance* BlueMaterial0;
	...
	UPROPERTY(EditAnywhere, Category = Elim)
	UMaterialInstance* RedMaterial0;
