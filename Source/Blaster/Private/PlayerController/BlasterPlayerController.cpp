...
void ABlasterPlayerController::HideTeamScores()
{
	...
	bool bHUDValid = BlasterHUD && BlasterHUD->CharacterOverlay && BlasterHUD->CharacterOverlay->RedTeamScore &&
		BlasterHUD->CharacterOverlay->BlueTeamScore && BlasterHUD->CharacterOverlay->ScoreSpacerText;
	if (bHUDValid)
	{
...
void ABlasterPlayerController::ShowReturnToMainMenu()
{
	...
	if (!ReturnToMainMenu)
	{
		ReturnToMainMenu = CreateWidget<UReturnToMainManu>(this, ReturnToMainMenuWidget);
	}
	if (ReturnToMainMenu)
	{
...
{
	BlasterHUD = !BlasterHUD ? Cast<ABlasterHUD>(GetHUD()) : BlasterHUD;
	bool bHUDValid = BlasterHUD && BlasterHUD->CharacterOverlay && BlasterHUD->CharacterOverlay->GrenadesAmount;
	if (bHUDValid)
	{
