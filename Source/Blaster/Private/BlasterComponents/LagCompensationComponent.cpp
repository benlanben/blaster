...
FShotgunServerSideRewindResult ULagCompensationComponent::ShotgunConfirmHit(const TArray<FFramePackage>&FramePackages, const FVector_NetQuantize & TraceStart, const TArray<FVector_NetQuantize>&HitLocations)
{
	...
	{
		if (!Frame.HitCharacter) return FShotgunServerSideRewindResult();
	}
	...
	for (auto& Frame : FramePackages)
	{
		...
		CacheBoxPositions(Frame.HitCharacter, CurrentFrame);
...
{
	bool bReturn = !HitCharacter || !HitCharacter->GetLagCompensation() || !HitCharacter->GetLagCompensation()->FrameHistory.GetHead() ||
	...
	{
		// too far back - too much lag to do SSR
